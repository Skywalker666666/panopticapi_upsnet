...
def convert_panoptic_to_detection_coco_format_single_core(
    ...
    for working_idx, annotation in enumerate(annotations_set):
        ...
        #print(os.path.join(segmentations_folder, file_name))
        ...
        for segm_info in annotation['segments_info']:
            ...
            lm = np.unique(mask)
            #print(lm)
            #print( "segm_info['id']: " + str(segm_info['id']))
            ...
            # 03-28-2021: this line is critical, otherwise, the segmentation might be empty 
            if len(segmentation) == 0:
                continue


            segm_info['segmentation'] = segmentation
